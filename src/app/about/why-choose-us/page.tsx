  ...
  return (
    <main className="w-full bg-white overflow-hidden min-h-screen">
      {/* ==========================================
          ...
          ========================================== */}
      <section 
        className="relative w-full bg-[#06142D] pt-[115px] pb-10 sm:pb-12 md:pb-14 overflow-hidden bg-cover bg-center"
      ...
      <section className="py-24 px-6 md:px-12 bg-white relative">
        <div className="max-w-[1280px] mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl font-extrabold text-slate-900 font-poppins">Find out how companies succeed with DIGINET</h2>
