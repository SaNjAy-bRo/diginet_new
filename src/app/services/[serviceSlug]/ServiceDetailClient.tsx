...
export default function ServiceDetailClient({
  ...
  const renderHeroSection = () => {
    switch (serviceSlug) {
      case "cybersecurity":
        return (
          <section className={`relative z-10 pt-12 pb-14 px-6 md:px-12 bg-gradient-to-b ${theme.gradientHero} text-white border-b border-slate-900 overflow-hidden`}>
            <MeshGrid />
      ...
      case "website-designing":
        return (
          <section className={`relative z-10 pt-12 pb-14 px-6 md:px-12 bg-gradient-to-br from-cyan-950 via-slate-950 to-slate-900 text-white border-b border-slate-900 overflow-hidden`}>
            <MeshGrid />
      ...
      case "mobile-development":
        return (
          <section className={`relative z-10 pt-12 pb-14 px-6 md:px-12 bg-gradient-to-b from-indigo-950 via-slate-900 to-slate-950 text-white border-b border-slate-900 overflow-hidden`}>
            <MeshGrid />
      ...
      case "application-development":
        return (
          <section className={`relative z-10 pt-12 pb-14 px-6 md:px-12 bg-gradient-to-r from-slate-950 via-purple-950 to-slate-900 text-white border-b border-slate-900 overflow-hidden`}>
            <MeshGrid />
      ...
      case "digital-marketing":
        return (
          <section className={`relative z-10 pt-12 pb-0 bg-slate-950 text-white border-b border-slate-900 overflow-hidden`}>
            <MeshGrid />
      ...
      case "social-media-management":
        return (
          <section className={`relative z-10 pt-12 pb-14 px-6 md:px-12 bg-gradient-to-b from-violet-950 via-slate-900 to-slate-950 text-white border-b border-slate-900 overflow-hidden`}>
            <MeshGrid />
